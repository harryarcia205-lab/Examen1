            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <form action="{{ route('order_lines.store') }}" method="POST" novalidate>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="article_id" name="article_id" value="{{ old('article_id') }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="requested_quantity" name="requested_quantity" value="{{ old('requested_quantity') }}"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 
                               focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
