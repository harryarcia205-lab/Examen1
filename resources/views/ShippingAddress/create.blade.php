            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <form action="{{ route('addresses.store') }}" method="POST" novalidate>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="neighborhood" name="neighborhood" value="{{ old('neighborhood') }}" maxlength="255"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 
                                      focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                        @error('neighborhood')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="location_reference" name="location_reference" value="{{ old('location_reference') }}" maxlength="255"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 
                                      focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="address_status" name="address_status" value="{{ old('address_status') }}" maxlength="255"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 
                                      focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
