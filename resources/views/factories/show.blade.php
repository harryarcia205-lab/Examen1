    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Nombre de la fábrica</h3>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Cedula de identidad</h3>
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $factory->identification_card ?? 'Esta fábrica no tiene cédula de identidad registrada.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $factory->telephone ?? 'Esta fábrica no tiene teléfono registrado.' }}
                    </div>
                </div>
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $factory->email ?? 'Esta fábrica no tiene email registrado.' }}
                    </div>
                </div>

                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Dirección</h3>
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $factory->address ?? 'Esta fábrica no tiene dirección registrada.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $factory->state_supplier ?? 'Esta fábrica no tiene estado de proveedor registrado.' }}
                    </div>
                </div>
