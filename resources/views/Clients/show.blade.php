            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $client->email ?? 'Este cliente no tiene correo electrónico registrado.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $client->telephone ?? 'Este cliente no tiene teléfono registrado.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $client->balance ?? 'Este cliente no tiene saldo registrado.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $client->credit_limit ?? 'Este cliente no tiene límite de crédito registrado.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $client->discount ?? 'Este cliente no tiene descuento registrado.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $client->date_record ?? 'Este cliente no tiene fecha de registro registrada.' }}
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 min-h-[100px]">
                        {{ $client->state_client?? 'Este cliente no tiene estado registrado.' }}
                    </div>
                </div>
