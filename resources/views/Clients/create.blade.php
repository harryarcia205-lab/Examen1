        ...
        <div class="max-w-7x1 mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('clients.store') }}" method="POST" novalidate>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="state_client" name="state_client" value="{{ old('state_client') }}" class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors" placeholder="Ej. Desarrollo Web">
                    @error('state_client')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
