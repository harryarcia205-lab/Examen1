<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <form action="{{ route('orders.update', $order) }}" method="POST" onsubmit="confirmUpdate(event)" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="client_id" name="client_id" value="{{ old('client_id', $order->client_id) }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="address_id" name="address_id" value="{{ old('address_id', $order->address_id) }}"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                        @error('address_id')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="datetime-local" id="created_at" name="created_at" value="{{ old('created_at', $order->created_at) }}"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                        @error('created_at')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" step="0.01" id="subtotal" name="subtotal" value="{{ old('subtotal', $order->subtotal) }}"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                        @error('subtotal')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" step="0.01" id="tax_amount" name="tax_amount" value="{{ old('tax_amount', $order->tax_amount) }}"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                        @error('tax_amount')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" step="0.01" id="grand_total" name="grand_total" value="{{ old('grand_total', $order->grand_total) }}"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                        @error('grand_total')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="additional_notes" name="additional_notes" rows="3" maxlength="255"
                                  class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">{{ old('additional_notes', $order->additional_notes) }}</textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="order_status" name="order_status" value="{{ old('order_status', $order->order_status) }}" maxlength="20"
                               class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-20 shadow-sm transition-colors">
                        @error('order_status')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
    ...
    <script>
        function confirmUpdate(event) {
            ...
            Swal.fire({
                title: 'Save changes?',
                text: "The order information will be updated.",
                icon: 'question',
