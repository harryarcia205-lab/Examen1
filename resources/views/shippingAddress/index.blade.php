                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <a href="{{ route('shipping_addresses.show', $shipping_addresses) }}" class="text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors" title="Ver">
                                            ...
                                            <form action="{{ route('shipping_addresses.destroy', $shipping_addresses) }}" method="POST" class="inline" id="form-delete-{{ $shipping_address->id }}">
                                                @csrf
                                                @method('DELETE')
