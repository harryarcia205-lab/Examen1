        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('order lines.index')" :active="request()->routeIs('order lines.*')">
                        {{ __('linea pedido') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('factory articles.index')" :active="request()->routeIs('factory articles.*')">
                        {{ __('factory articles') }}
                    </x-nav-link>

                    <x-nav-link :href="route('factory.index')" :active="request()->routeIs('factory.*')">
                        {{ __('fabrica') }}
                    </x-nav-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('categories.index')" :active="request()->routeIs('categories.*')">
                ...
                <x-responsive-nav-link :href="route('clients.index')" :active="request()->routeIs('clients.*')">
                    ...
                    <x-responsive-nav-link :href="route('shippingAddress.index')" :active="request()->routeIs('shippingAddress.*')">
                        {{ __('Direccion Envio') }}
                    </x-responsive-nav-link>
                    ...
                    <x-responsive-nav-link :href="route('order lines.index')" :active="request()->routeIs('order lines.*')">
                        {{ __('linea pedido') }}
                    </x-responsive-nav-link>
                    ...
                    <x-responsive-nav-link :href="route('factory articles.index')" :active="request()->routeIs('factory articles.*')">
                        {{ __('factory articles') }}
                    </x-responsive-nav-link>

                    <x-responsive-nav-link :href="route('factory.index')" :active="request()->routeIs('factory.*')">
                        {{ __('fabrica') }}
                    </x-responsive-nav-link>
